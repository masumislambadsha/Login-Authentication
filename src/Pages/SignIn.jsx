...
const Signin = () => {
  ...
  const handleSignout = () => {
    signOut(auth)
      .then(() => {
        setUser(null);
        toast.success("Successfully Signed Outt!", {
          position: "bottom-center",
          autoClose: 5000,
          hideProgressBar: false,
          closeOnClick: true,
              ...
              <form onSubmit={handleSignin} className="space-y-5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    name="password"
                    placeholder="••••••••"
                    className="input input-border ed w-full bg-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                  <span
